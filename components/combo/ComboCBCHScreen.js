...
const ComboCBCHScreen = () => {
  ...
  return (
    <View style={styles.container}>
      ...
      // Truyền cả selectedCombos và selectedSeats khi chuyển sang trang CheckInformationCBCH
      navigation.navigate('CheckInformationCBCH', {
        selectedDate,
        selectedDay,
        selectedTime,
        selectedCinema,
...
export default ComboCBCHScreen;
