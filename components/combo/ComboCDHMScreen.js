...
const ComboCDHMScreen = () => {
  ...
  return (
    <View style={styles.container}>
      ...
      // Truyền cả selectedCombos và selectedSeats khi chuyển sang trang CheckInformationCDHM
      navigation.navigate('CheckInformationCDHM', {
        selectedDate,
        selectedDay,
        selectedTime,
        selectedCinema,
...
export default ComboCDHMScreen;
