...
const PaymentDetailsCDHM = () => {
  ...
  const handleConfirm = async () => {
    ...
    if (result.success) {
      ...
      const ticketDetails = {
        movieName: 'Cô Dâu Hào Môn', // Tên phim
      ...
      // Chuyển tới màn SuccessCDHMScreen
      navigation.navigate("SuccessCDHMScreen");
    } else {
...
export default PaymentDetailsCDHM;
