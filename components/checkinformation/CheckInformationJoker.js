...
const CheckInformationJoker = ({ route }) => {
          ...
          <View style={styles.ticketInfoContainer}>
            ...
            <View style={styles.ticketLower}>
              ...
              <View style={styles.ticketRight}>
                ...
                <Text style={styles.value}>Tội Phạm</Text>
  ...
  onPress={() => {
    // Truyền tổng tiền và các thông tin cần thiết khi điều hướng đến PaymentDetailsJoker
    navigation.navigate('PaymentDetailsJoker', {
...
export default CheckInformationJoker;