...
const CheckInformationCDHM = ({ route }) => {
  ...
  onPress={() => {
    // Truyền tổng tiền và các thông tin cần thiết khi điều hướng đến PaymentDetailsCDHM
    navigation.navigate('PaymentDetailsCDHM', {
...
export default CheckInformationCDHM;