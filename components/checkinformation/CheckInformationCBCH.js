...
const CheckInformationCBCH = ({ route }) => {
        ...
        <ScrollView style={styles.content} contentContainerStyle={styles.scrollContainer}>
          ...
          <View style={styles.ticketInfoContainer}>
            ...
            <View style={styles.ticketUpper}>
              <Image source={require('../../image/CBCH1.png')} style={styles.poster} />
            ...
            <View style={styles.ticketLower}>
              ...
              <View style={styles.ticketRight}>
                ...
                <Text style={styles.value}>Gia đình, Hoạt hình</Text>
  ...
  onPress={() => {
    // Truyền tổng tiền và các thông tin cần thiết khi điều hướng đến PaymentDetailsCBCH
    navigation.navigate('PaymentDetailsCBCH', {
...
export default CheckInformationCBCH;