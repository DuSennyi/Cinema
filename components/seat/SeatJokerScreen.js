...
const SeatJokerScreen = ({route, navigation }) => {  
  ...
  const handleContinue = () => {
    if (selectedSeats.length === 0) {
      ...
      navigation.navigate('ComboJokerScreen', {
...
const styles = StyleSheet.create({
  ...
  // Đường phân cách
  separator: {
    borderBottomWidth: 1, // Độ dày của đường phân cách
    borderBottomColor: '#ddd', // Màu sắc của đường phân cách
    marginVertical: 8, // Khoảng cách trên và dưới đường phân cách
    marginTop: 1, // Khoảng cách phía trên đường phân cách
  },
});
export default SeatJokerScreen;
