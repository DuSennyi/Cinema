            ...
            <ScrollView contentContainerStyle={styles.scrollViewContent}>
                <View style={styles.content}>
                    ...
                    <Text style={styles.message}>
                        Bạn đã đặt thành công vé xem phim "JOKER: FOLIE À DEUX ĐIÊN CÓ ĐÔI", chúc bạn sẽ có những phút xem phim tuyệt vời.
                    </Text>
                </View>
                ...
                <TouchableOpacity style={styles.moviePoster} onPress={() => navigation.navigate('Captain')}>
                    <Image source={require('../../image/NhimSonic2.png')} style={styles.moviePoster}/>
                </TouchableOpacity>

                <TouchableOpacity style={styles.moviePoster} onPress={() => navigation.navigate('DiaDao')}>
                    <Image source={require('../../image/mufasa2.png')} style={styles.moviePoster}/>
                </TouchableOpacity>
...
export default SuccessJokerScreen;
