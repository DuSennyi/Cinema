            ...
            <ScrollView contentContainerStyle={styles.scrollViewContent}>
                <View style={styles.content}>
                    ...
                    <Text style={styles.message}>
                        Bạn đã đặt thành công vé xem phim "CÁM", chúc bạn sẽ có những phút xem phim tuyệt vời.
                    </Text>
                </View>
                ...
                <TouchableOpacity style={styles.moviePoster} onPress={() => navigation.navigate('Captain')}>
                    <Image source={require('../../image/captain2.png')} style={styles.moviePoster}/>
                </TouchableOpacity>

                <TouchableOpacity style={styles.moviePoster} onPress={() => navigation.navigate('DiaDao')}>
                    <Image source={require('../../image/DiaDao2.png')} style={styles.moviePoster}/>
                </TouchableOpacity>
...
export default SuccessCamScreen;
