...
const PaymentDetailsCBCH = () => {
  ...
  const calculateFinalPrice = () => {
    ...
    const ticketPrice = 199000; // Thêm giá vé vào, có thể lấy từ params nếu cần
  ...
  return (
    <View style={styles.container}>
      ...
      <ScrollView contentContainerStyle={styles.scrollViewContent} style={{ flexGrow: 1 }}>
        ...
        <TouchableOpacity onPress={() => navigation.navigate('PaymentCBCHScreen')}>
...
export default PaymentDetailsCBCH;
