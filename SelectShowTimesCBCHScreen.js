...
const SelectShowTimesCBCHScreen = () => {
  ...
  const handleContinue = () => {
    navigation.navigate('SeatCBCHScreen', {
      selectedDate,
      selectedDay,
      selectedTime,
      selectedCinema
  ...
  return (
    <ScrollView style={styles.container}>
      ...
      <View style={styles.header}>
        <TouchableOpacity style={styles.backButton} onPress={() => navigation.navigate('CBCH')}>
      ...
      <View style={styles.movieInfo}>
        <Image source={require('./film/image/CBCH1.png')} style={styles.movieImage} />
...
export default SelectShowTimesCBCHScreen;
