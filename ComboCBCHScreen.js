...
///////////////////////////////////
      <View style={styles.legend}>
        {/* Mục trên: Đã đặt và Ghế bạn chọn */}
        ...
        {/* Mục dưới: Ghế thường, Ghế VIP, Ghế Sweetbox */}
...
//////////////////////////////////////////
      ...
      <View style={styles.selectedSeats}>
        {/* Hiển thị tiêu đề "Suất chiếu" */}
        <Text style={styles.label}>Suất chiếu:</Text>

        {/* Hộp chứa giờ chiếu */}
        <View style={styles.showTimeBox}>
          <Text style={styles.showTimeText}>{selectedTime}</Text> {/* Hiển thị giờ chiếu */}
        </View>
        <Text style={styles.label}>Ghế:</Text>
        
        {/* Hiển thị từng ghế trong ô vuông */}
